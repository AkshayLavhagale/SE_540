"""Akshay Lavhagale
   ...
   Your program can hard code the address for the White House but should ask for your address in the
   U.S. including street, city and state, and should report out its results """
...
def geocoderesult(address, benchmark='Public_AR_Current', vintage='ACS2018_Current'):
    ...
    param1 = {'street': address['street'], 'city': address['city'], 'state': address['state'], 'benchmark': benchmark,
...
if __name__ == "__main__":
    ...
    dis = cal_distance(user_loc, white_house_loc)
